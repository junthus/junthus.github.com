...
---|---|---|---|---
앙2+| 구글 + 교재의양 | 유지보수 누가해... | 웹표준과 쫌 다른 노선(web component, pwa등) | 이미 잘 쓰고 있었다면 할만 함. 아니면 만드려는게 모델-뷰 패턴에 꼭 맞으면 갠춘. 혹은 Material UI 편하게 쓰구 싶다면.
React<br>Redux| 페북 + 단순 + 유저수 | 추가 기능 솔루션 파편화, 라이센스 장난질 | 반반 | 러닝커브 완만
